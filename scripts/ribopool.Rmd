...
#gwc <- gwc_other[,c(2,7:length(gwc_other[2,]))]
...
detected_types <- data.frame(unique_lt = annot_sites$unique_lt, 
                             ...
                             alt_site_detected = annot_sites$unique_lt %in% novel_sites$unique_lt[novel_sites$peak_found_Hör=="True"], alt_site_detected_meydan = annot_sites$unique_lt %in% novel_sites$unique_lt[novel_sites$peak_found_meydan=="True"], annot_site_detected_meydan = as.logical(toupper(annot_sites$peak_found_meydan)),
...
venn <- plot(venn(detected_types[-5][c(1,4,2,3)]))
